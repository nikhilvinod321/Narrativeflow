...
class StoryExtractor:
    ...
    async def extract_story_elements(self, title: str, content: str, chapters: List[Dict]) -> Dict:
        """
        ...
        metadata = await self._extract_metadata(title, content, chapters)
        
        # Extract characters
        characters = await self._extract_characters(content, chapters)
        
        # Extract plotlines
        plotlines = await self._extract_plotlines(content, chapters)
    ...
    async def _extract_metadata(self, title: str, content: str, chapters: List[Dict]) -> Dict:
...
JSON:"""
    ...
    async def _extract_characters(self, content: str, chapters: List[Dict]) -> List[Dict]:
...
JSON:"""
    ...
    async def _extract_plotlines(self, content: str, chapters: List[Dict]) -> List[Dict]:
